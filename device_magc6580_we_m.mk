...
$(call inherit-product-if-exists, vendor/bluboo/magc6580_we_m/magc6580_we_m-vendor.mk)

DEVICE_PACKAGE_OVERLAYS += device/bluboo/magc6580_we_m/overlay
PRODUCT_PACKAGE_OVERLAYS += device/bluboo/magc6580_we_m/overlay # enable this to be able overlay a default wallpaper
